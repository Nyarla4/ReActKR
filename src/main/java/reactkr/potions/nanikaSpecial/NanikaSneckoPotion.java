...
public class NanikaSneckoPotion extends AbstractPotion {
    public static String POTION_ID = makeID("NanikaSneckoPotion");
    private static final PotionStrings potionStrings;

    public NanikaSneckoPotion() {
        super(potionStrings.NAME, POTION_ID, PotionRarity.PLACEHOLDER, PotionSize.SNECKO, PotionColor.SNECKO);
        this.isThrown = false;
    }
