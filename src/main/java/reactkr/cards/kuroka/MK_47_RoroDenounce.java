...
public class MK_47_RoroDenounce extends AbstractEasyCard_Kuroka {
    public final static String ID = makeID("RoroDenounce");
    // intellij stuff attack, enemy, basic, 6, 3,  , , ,

    public MK_47_RoroDenounce() {
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        AbstractRorokaPower pow = (AbstractRorokaPower) p.getPower(MK_13_RoroDenounce_Power.POWER_ID);
        if (pow == null) {
