...
import reactkr.powers.kuroka.MK_13_RoroDenounce_Power;
...
public class MK_48_RoroHochi extends AbstractEasyCard_Kuroka {
    public final static String ID = makeID("RoroHochi");
    // intellij stuff attack, enemy, basic, 6, 3,  , , ,

    public MK_48_RoroHochi() {
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        AbstractRorokaPower pow = (AbstractRorokaPower) p.getPower(MK_14_RoroHochi_Power.POWER_ID);
        if (pow == null) {
            pow = new MK_14_RoroHochi_Power(p, magicNumber);
