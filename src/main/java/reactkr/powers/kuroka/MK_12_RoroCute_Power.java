...
public class MK_12_RoroCute_Power extends AbstractRorokaPower {
    public static final String POWER_ID = makeID("RoroCutePower");
    private static final PowerStrings powerStrings;
    public static final String NAME;
    public static final String[] DESCRIPTIONS;
    private static final Logger logger = LogManager.getLogger(MK_12_RoroCute_Power.class.getName());

    public MK_12_RoroCute_Power(AbstractCreature owner, int amount) {
