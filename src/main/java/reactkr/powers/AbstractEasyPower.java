...
import reactkr.util.TexLoader;

import static reactkr.ModFile.modID;
...
public abstract class AbstractEasyPower extends AbstractPower {
    ...
    protected boolean justApplied = false;
    protected static String POWER_ID;
    ...
    public AbstractEasyPower(String ID, String NAME, PowerType powerType, boolean isTurnBased, AbstractCreature owner, int amount) {
        ...
        Texture normalTexture = TexLoader.getTexture(modID + "Resources/images/powers/" + ID.replaceAll(modID + ":", "") + "32.png");
        Texture hiDefImage = TexLoader.getTexture(modID + "Resources/images/powers/" + ID.replaceAll(modID + ":", "") + "84.png");
        if (hiDefImage != null) {
